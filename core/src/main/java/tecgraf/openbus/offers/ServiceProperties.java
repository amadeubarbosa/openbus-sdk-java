 ...
 * barramento.
 * <p>
 * O usuário pode definir propriedades com chaves customizadas que
...
public class ServiceProperties {
   ...
   * publicado. Equivalente ao método <code>Date.getTimeInMillis()</code>
   * <p>
  ...
  /**
   * Número de patch de versionamento, indica correções de bugs e alterações que
   * não impactam na solução.
   * <p>
