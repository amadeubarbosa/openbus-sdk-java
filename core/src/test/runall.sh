...
export OPENBUS_TESTCFG=$OPENBUS_SANDBOX/build/openbus-java-$sdkjava_ver/core/test/resources/test.properties
...
echo "system.private.key = test/resources/TestEntity.key" >> $OPENBUS_TESTCFG
echo "system.wrong.key = test/resources/wrongkey.key" >> $OPENBUS_TESTCFG
