...
%% ATUALIZAR %% >>
A demo Hello Java do \assistant{} possui um executável servidor e outro cliente e pode ser executada de acordo com as instruções do arquivo README.txt que a acompanha.
%% ATUALIZAR %% <<
