...
Como resultado de uma autenticação bem sucedida é gerado um \term{login} dentro do barramento, que fica associado a identidade autenticada, ilustrado na figura~\ref{fig:bus_02}, onde o crachá representa o \term{login} associado a entidade autenticada.
...
\inputimage{bus_02}{As partes conectadas ao barramento após uma prova de autenticação.}
