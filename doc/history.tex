...
\subsubsection{Comunicação Padronizada}\label{subsec:comm}
\begin{itemize}
...
\subsubsection{Acesso Identificado}\label{subsec:id}
\begin{itemize}
...
\subsubsection{Descoberta de Serviços}\label{subsec:find}
\begin{itemize}
...
\subsubsection{Governança Centralizada}\label{subsec:gov}
\begin{itemize}
