A demo Hello SSL tenta demonstrar a aplicação mais simples possível. Um servidor 
fornece o servant da interface Hello e o cliente realiza uma chamada "sayHello"
nesse servant, sendo que ambos se conectam através de um canal seguro
...
----------- SUPORTE SSL -------
-------------------------------
Caso queira rodar a demo usando o protocolo SSL para criar conexões seguras,
use o scripts runhelloserverssl.sh para rodar o servidor e o
runhelloserverclient.sh para rodar o cliente.

Esses scripts executam a demo através do maven e definem um arquivo com
...
obs.: legacy é o domínio de validação para o login do usuário.
