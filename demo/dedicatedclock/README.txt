...
1) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-dedicatedclock-2.0.2-SNAPSHOT.jar demo.DedicatedClockServer localhost 2089 demo_dedicatedclock_java DemoDedicatedClock.key

2) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-dedicatedclock-2.0.2-SNAPSHOT.jar demo.DedicatedClockClient localhost 2089 demo_dedicatedclock_java_client minhasenha
