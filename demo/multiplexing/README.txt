...
1) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-multiplexing-2.1.0-SNAPSHOT.jar demo.MultiplexingServer localhost 2089 demo_multiplexing_java DemoMultiplexing.key

2) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-multiplexing-2.1.0-SNAPSHOT.jar demo.MultiplexingClient localhost 2089 demo_multiplexing_java_client minhasenha
