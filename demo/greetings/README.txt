...
1) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-greetings-2.0.1.0.jar demo.GreetingsServer localhost 2089 demo_greetings_java DemoGreetings.key 

2) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-greetings-2.0.1.0.jar demo.GreetingsClient localhost 2089 demo_greetings_java_client minhasenha Spanish
