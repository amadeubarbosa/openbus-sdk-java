...
1) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-independentclock-2.0.2-SNAPSHOT.jar demo.IndependentClockServer localhost 2089 demo_independentclock_java DemoIndependentClock.key

2) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-independentclock-2.0.2-SNAPSHOT.jar demo.IndependentClockClient localhost 2089 demo_independentclock_java_client minhasenha
