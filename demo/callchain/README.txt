...
openbus-sdk-core-2.1.1.0.jar
openbus-sdk-demo-util-2.1.1.0.jar
openbus-sdk-legacy-2.1.1.0.jar
...
1) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-callchain-2.1.1.0.jar demo.CallChainServer localhost 2089 demo_callchain_java DemoCallChain.key

2) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-callchain-2.1.1.0.jar demo.CallChainProxy localhost 2089 demo_callchain_java DemoCallChain.key

3) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-callchain-2.1.1.0.jar demo.CallChainClient localhost 2089 demo_callchain_java_client minhasenha
