...
2) java -Djava.endorsed.dirs=./lib/ -cp $(echo lib/*.jar | tr ' ' ':'):openbus-sdk-demo-hello-2.1.0-SNAPSHOT.jar demo.HelloClient localhost 2089 demo_hello_java_client minhasenha
